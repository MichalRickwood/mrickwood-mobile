...
const cs: Dict = {
  ...
  aiAnalysis: {
    ...
    profileRequiredTitle: "Chcete analýzu s profilem firmy?",
    profileRequiredBody: "Analýzu můžete spustit rovnou. S profilem firmy bude přesnější — AI pozná, co umíte a co vám u zakázky chybí.",
    profileRequiredCta: "Nastavit firemní profil",
    profileRequiredWithout: "Spustit bez profilu",
  ...
  auth: {
    ...
    registerSubtitle: "Začněte sledovat veřejné zakázky",
    loginBtn: "Přihlásit se",
    loginSubtitle: "Vítejte zpět",
    showPassword: "Zobrazit heslo",
    hidePassword: "Skrýt heslo",
    passwordHint: "Alespoň 8 znaků.",
    openEmailApp: "Otevřít e-mail",
    ...
    toLogin: "Už máte účet? Přihlásit se",
    toRegister: "Nemáte účet? Vytvořit",
    verifyTitle: "Ověřte svůj e-mail",
    verifyBody: "Poslali jsme ověřovací odkaz na {email}. Klikněte na něj a pak se přihlaste.",
    ...
    errConsent: "Musíte souhlasit s podmínkami.",
    errExists: "Účet s tímto e-mailem už existuje.",
    errInvalid: "Neplatný e-mail nebo heslo.",
    errNotVerified: "Nejdřív ověřte e-mail (zkontrolujte schránku).",
    errNetwork: "Chyba sítě. Zkuste to znovu.",
    errGeneric: "Něco se pokazilo. Zkuste to znovu.",
    orContinue: "nebo pokračujte přes",
    googleBtn: "Pokračovat s Google",
    clickwrapPrefix: "Pokračováním souhlasíte s",
    clickwrapAnd: "a",
  },
...
const en: Dict = {
  ...
  aiAnalysis: {
    ...
    profileRequiredTitle: "Run the analysis with a company profile?",
    profileRequiredBody: "You can run the analysis right away. With a company profile it will be more precise — the AI can tell what you do and what you are missing for the tender.",
    profileRequiredCta: "Set up company profile",
    profileRequiredWithout: "Run without a profile",
...
const de: Dict = {
  ...
  aiAnalysis: {
    ...
    profileRequiredTitle: "Analyse mit Firmenprofil?",
    profileRequiredBody: "Sie können die Analyse sofort starten. Mit einem Firmenprofil wird sie genauer — die KI erkennt, was Sie können und was Ihnen für die Ausschreibung fehlt.",
    profileRequiredCta: "Firmenprofil einrichten",
    profileRequiredWithout: "Ohne Profil starten",
...
const sk: Dict = {
  ...
  matches: {
    ...
    filterFormValueRange: "Predpokladaná hodnota (Kč)",
  ...
  aiAnalysis: {
    ...
    profileRequiredTitle: "Chcete analýzu s profilom firmy?",
    profileRequiredBody: "Analýzu môžete spustiť rovno. S profilom firmy bude presnejšia — AI spozná, čo viete a čo vám pri zákazke chýba.",
    profileRequiredCta: "Nastaviť firemný profil",
    profileRequiredWithout: "Spustiť bez profilu",
  ...
  auth: {
    ...
    registerSubtitle: "Začnite sledovať verejné zákazky",
    loginBtn: "Prihlásiť sa",
    loginSubtitle: "Vitajte späť",
    showPassword: "Zobraziť heslo",
    hidePassword: "Skryť heslo",
    passwordHint: "Aspoň 8 znakov.",
    openEmailApp: "Otvoriť e-mail",
    ...
    toLogin: "Už máte účet? Prihlásiť sa",
    toRegister: "Nemáte účet? Vytvoriť",
    verifyTitle: "Overte svoj e-mail",
    verifyBody: "Poslali sme overovací odkaz na {email}. Kliknite naň a potom sa prihláste.",
    verifyGotIt: "Prejsť na prihlásenie",
    webBtn: "Prihlásiť cez web (Google/Apple)",
    webLoading: "Otváram…",
    errEmailInvalid: "Neplatný e-mail.",
    errPasswordShort: "Heslo musí mať aspoň 8 znakov.",
    errConsent: "Musíte súhlasiť s podmienkami.",
    errExists: "Účet s týmto e-mailom už existuje.",
    errInvalid: "Neplatný e-mail alebo heslo.",
    errNotVerified: "Najprv overte e-mail (skontrolujte schránku).",
    errNetwork: "Chyba siete. Skúste to znova.",
    errGeneric: "Niečo sa pokazilo. Skúste to znova.",
    orContinue: "alebo pokračujte cez",
    googleBtn: "Pokračovať s Google",
    clickwrapPrefix: "Pokračovaním súhlasíte s",
    clickwrapAnd: "a",
  },
  locale: { cs: "Čeština", en: "English", de: "Deutsch", sk: "Slovenčina", fr: "Français", it: "Italiano" },
};
...
const fr: Dict = {
  ...
  aiAnalysis: {
    ...
    profileRequiredTitle: "Lancer l'analyse avec un profil d'entreprise ?",
    profileRequiredBody: "Vous pouvez lancer l'analyse tout de suite. Avec un profil d'entreprise, elle sera plus précise — l'IA saura ce que vous savez faire et ce qui vous manque pour ce marché.",
    profileRequiredCta: "Configurer le profil",
    profileRequiredWithout: "Lancer sans profil",
...
const it: Dict = {
  ...
  aiAnalysis: {
    ...
    profileRequiredTitle: "Analisi con il profilo aziendale?",
    profileRequiredBody: "Puoi avviare l'analisi subito. Con un profilo aziendale sarà più precisa — l'AI capirà cosa sai fare e cosa ti manca per il bando.",
    profileRequiredCta: "Imposta profilo aziendale",
    profileRequiredWithout: "Avvia senza profilo",
