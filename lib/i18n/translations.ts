...
const cs: Dict = {
  ...
  settings: {
    ...
    billingProformaRegenerate: "Přegenerovat zálohovou fakturu",
...
const en: Dict = {
  ...
  settings: {
    ...
    billingProformaRegenerate: "Regenerate proforma invoice",
...
const de: Dict = {
  ...
  settings: {
    ...
    billingProformaRegenerate: "Vorausrechnung neu generieren",
